    ...
    <section ref={containerRef} id="hero" className="relative h-[150vh] w-full overflow-hidden bg-[#0d0a0d]">
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        <motion.div 
          ...
          className="relative z-10 h-full flex items-center justify-center px-6 pt-40"
        >
          {!isBooted ? (
            ...
            <div className="flex flex-col items-center text-center space-y-12 max-w-5xl">
              ...
              <div className="space-y-6">
                <motion.h1
                  ...
                  className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-bold tracking-tighter text-white leading-[1.1] md:leading-[1]"
                >
                  Building with <br />
                  <span className="relative inline-block px-1 sm:px-2">
                    ...
                    <motion.div 
                      ...
                      className="absolute inset-x-0 bottom-1 sm:bottom-2 h-[30%] bg-purple-500/20 rounded-sm origin-left -rotate-1"
                    />
                  </span>
                  {" "}&{" "}
                  <span className="relative inline-block px-1 sm:px-2">
                ...
                <motion.p
                  ...
                  className="max-w-2xl mx-auto text-white/60 text-base sm:text-xl md:text-2xl font-light leading-relaxed px-4 sm:px-0"
                >
              ...
              <motion.div
                ...
                className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 w-full sm:w-auto px-6 sm:px-0"
              >
                <a
                  href="#projects"
                  className="w-full sm:w-auto text-center group relative px-8 sm:px-10 py-4 sm:py-5 bg-white text-black rounded-2xl font-bold overflow-hidden transition-all hover:scale-105 active:scale-95"
                >
                ...
                <a
                  href="#contact"
                  className="w-full sm:w-auto text-center px-8 sm:px-10 py-4 sm:py-5 bg-white/5 border border-white/10 backdrop-blur-xl text-white rounded-2xl font-bold hover:bg-white/10 transition-all hover:scale-105 active:scale-95"
                >
                  Get in Touch
                </a>
              </motion.div>
