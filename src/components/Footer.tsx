    ...
    <footer id="contact" className="relative py-32 bg-[#0d0a0d] overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-32">
            ...
            <div className="flex flex-wrap gap-6">
              {socialLinks.map((link, i) => (
                <motion.a
                  ...
                  className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-white/60 hover:text-purple-400 hover:border-purple-500/30 transition-all shadow-2xl"
          ...
          <div className="glass-panel rounded-[3rem] p-12 space-y-12">
            <div className="space-y-4">
              <h3 className="text-xs font-mono uppercase tracking-[0.4em] text-purple-400">Direct Contact</h3>
              <a href="mailto:augustya13y@gmail.com" className="group flex items-center justify-between text-2xl md:text-3xl font-bold text-white hover:text-purple-400 transition-colors">
            ...
            <div className="space-y-4">
              <h3 className="text-xs font-mono uppercase tracking-[0.4em] text-purple-400">Location</h3>
              <div className="text-2xl font-light text-white/60">
                Gurgaon, India <br />
                <span className="text-sm font-mono text-white/20 uppercase tracking-widest"></span>
              </div>
            </div>
          </div>
        </div>
